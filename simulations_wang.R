...
#           Wang data generating mechanism for the manuscript entitled:
#
...
dgm_wang <- function(true_beta, x1, x2, x3, x4, err) {

  return(true_beta * x1 + 0.5 * x2 + 3 * as.numeric(smooth(x3)) +

    4 * as.numeric(smooth(x4)) + err)
}
